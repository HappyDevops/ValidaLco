...
{
    [TestClass]
    public class ValidaLcoPruebas_IntegradorPorDefecto
    {
        ...
        private TokenIntegrador ObtenIntegradorPorDefecto()
        {
            ...
            return configuracionTesting.IntegradorPorDefecto.UsuarioIntegrador;
        }

        private RFC ObtenEmisorPorDefecto()
        {
            var configuracionTesting = UtilsConfigSections.ObtenConfiguracionKit();
            return configuracionTesting.IntegradorPorDefecto.Emisor;
        }
    }
}
